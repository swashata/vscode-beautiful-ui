...
const styles = theme => ({
	statusbar: {
		background:
			theme.type === 'dark' ? theme.bgDarkest() : theme.bgPrimary(),
...
const StatusBar = ({ classes, language }) => (
	<div className={`bui-vsc-statusbar ${classes.statusbar}`}>
		<div className="bui-vsc-statusbar__git">
			<svg
				width="256"
				height="256"
		...
		<div className="bui-vsc-statusbar__lang">{language}</div>
	</div>
);

export default injectStyles(styles)(StatusBar);
