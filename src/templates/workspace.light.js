module.exports = {
	colors: {
		...
		'dropdown.listBackground': '<%= bgPrimary() %>',
		...
		'inputOption.activeBorder': '<%= bgDarkest() %>',
		...
		'sideBarSectionHeader.background': '<%= bgPrimary() %>',
		...
		'editorSuggestWidget.selectedBackground': '<%= bgDarker() %>',
