...
const Template = {
	...
	tokens: {
		editor: {
			background: '#292d3d', // [background]
			foreground: Color('#959dcb')
				.hsl()
				.lighten(0.2)
				.hex(), // [foreground]
		},
		gutter: {
			background: '#292d3d', // [gutter]
		...
		blockquote: {
			...
			foreground: '#9398b4', // [markup.quote]
		},
		link: '#80a8ff', // [markup.underline.link, string.other.link]
		comment: '#666d93', // [comment] comment, punctuation.definition.comment
		...
		color7: '#8489a9', // [punctuation.separator] Property, Separator, Terminator, list_item
		color8: '#b1b4c9', // [entity.other.pseudo-class] Pseudo Property
