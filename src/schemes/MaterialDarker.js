...
const Template = {
	...
	tokens: {
		...
		blockquote: {
			...
			foreground: '#787878', // [markup.quote]
		},
		link: '#80a8ff', // [markup.underline.link, string.other.link]
		comment: '#525252', // [comment] comment, punctuation.definition.comment
		...
		color7: '#6b6b6b', // [punctuation.separator] Property, Separator, Terminator, list_item
		color8: '#919191', // [entity.other.pseudo-class] Pseudo Property
